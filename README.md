...
<div align="center">
  ...
  <h3 align="center">PetPals Backend</h3>

  <p align="center">
    A backend for the PetPals Project
    <br />
  </p>
</div>
...
This project is about setting up a stable backend for the PetPals Application using ASP.Net <br/>
*Note that this is an ongoing project and it's in the very early stages.*
...
* .Net SDK
* PostgreSQL
* Rider (Optional but recommended)
...
1. Clone the repository:
   ```sh
   git clone https://github.com/dudasdominik/PetPalsBackend.git
   ```
2. Navigate to the project directory:
    ```sh
   cd PetPalsBackend
   ```
3. Make a Database called PetPals in PostreSQL:
  
4. In the appsetting.json you need to change to your User Id and Password:
  
5. Build the project using .NET CLI:
    ```sh
   dotnet build
   ```
